config = {
    ...
    'slideshow': {
        ...
        'display_width': 1200,  # These 2 can be left as 0. Specify them only if you don't get fullscreen (happens in some devices).
        'display_height': 1920,
        'pause': {
            'start': None,  # If set, the slideshow will pause at this time and will show a black screen. In windows it also lowers the brightness to 0.
            'end': None
        },
        'low_brightness': {
    ...
    'general': {
        'locale': 'es_ES.utf8',  # For English use en_US.UTF-8
